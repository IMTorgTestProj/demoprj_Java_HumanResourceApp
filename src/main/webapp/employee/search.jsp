				...
				<div id="search_container" class="search_box">
					<form action="Controller" class="form-inline" role="form">
						...
						<div class="form-group">
							...
							<input name="searchemployee" type="text" class="form-control" id="searchemployee" placeholder="Social Security Number" maxlength="10">
						</div>
						...
						<tbody>
							<c:forEach items="${employees}" var="employee">
								<tr>
									...
									<td><c:out value="${employee.salaryType}" /></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
