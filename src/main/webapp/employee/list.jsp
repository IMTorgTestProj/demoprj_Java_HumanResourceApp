						...
						<tbody>
							<c:forEach items="${employees}" var="employee">
								<tr>
									...
									<td><c:out value="${employee.initMiddle}" /></td>
									<td><c:out value="${employee.ssn}" /></td>
									<td class="actioncol"><a href="<%=contextPath%>/employee/Controller?action=view&id=<c:out value="${employee.employeeId}"/>">view</td>
									<td class="actioncol"><a href="<%=contextPath%>/employee/Controller?action=edit&id=<c:out value="${employee.employeeId}"/>">edit</td>
									<td class="actioncol"><a href="<%=contextPath%>/employee/Controller?action=delete&id=<c:out value="${employee.employeeId}"/>">delete</td>
								</tr>
							</c:forEach>
						</tbody>
