...
<ul id="menu" class="nav nav-tabs">
	...
	<li class="dropdown"><a class="dropdown-toggle"
		...
		<ul class="dropdown-menu">
			<li><a href="<%=contextPath%>/addemployee.html">New</a></li>
	...
	<li class="dropdown"><a class="dropdown-toggle"
		...
		<ul class="dropdown-menu">
			...
			<li><a href="<%=contextPath%>/job/Controller?action=list">List
					(All Jobs)</a></li>
	...
	<li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Assignment<span
		...
		<ul class="dropdown-menu">
			...
			<li><a href="<%=contextPath%>/jobassignmentlist.html">Employee
					Assignment</a></li>
			<li><a href="<%=contextPath%>/searchjobassignment.html">Search
					Assignment</a></li>
		</ul></li>
	<li><a href="#">Help</a></li>
</ul>