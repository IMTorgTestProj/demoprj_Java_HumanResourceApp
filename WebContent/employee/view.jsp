...
<%
	...
	List<String> location = (List<String>) session.getAttribute("location");
%>
			...
			<div id="container_body">
				<form method="POST" action="Controller" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input id="firstname" name="firstname" type="text" class="form-control" disabled>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2" for="lastname">Last Name:</label>
						<div class="col-sm-6">
							<input id="lastname" name="lastname" type="text" class="form-control" disabled>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2" for="initial">Middle Initial:</label>
						<div class="col-sm-1">
							<input id="initial" name="initial" type="text" class="form-control" disabled>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2" for="ssn">SSN:</label>
						<div class="col-sm-6">
							<input id="ssn" name="ssn" type="text" class="form-control" disabled>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-6">							
							<input name="addemployeebtn" type="button" class="col-sm-offset-1 btn btn-default" value="Add" />
