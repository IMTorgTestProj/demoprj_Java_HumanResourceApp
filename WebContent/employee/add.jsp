			...
			<div id="container_body">
				<form method="POST" action="Controller" class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-1">
							<input id="initial" name="initial" type="text" class="form-control" placeholder="Initial">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2" for="ssn">SSN:</label>
						<div class="col-sm-6">
							<input id="ssn" name="ssn" type="text" class="form-control" placeholder="XXX-XX-XXX">
						</div>
					</div>
					<div class="form-group">
